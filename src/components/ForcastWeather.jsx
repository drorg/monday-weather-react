...
function ForcastWeather({ location }) {
    ...
    const { flagIcon, countryCode, temp, description, icon, humidity, windTransform, windSpeed, unitsSymbol } = React.useMemo(() => {
    ...
    return (
        <>
            ...
            <div className={classes.detailLine}>
                ...
                <List >
                    <ListItem>
                        {temp && <Typography variant="h6">Temp: {temp}&deg;{unitsSymbol}</Typography>}
                        {icon && (
                    ...
                    <ListItem>
                        {humidity && <Typography variant="h6">Humidity: {humidity}&deg;</Typography>}
                    </ListItem>
                    <ListItem>
                        {windSpeed > 0 && (
                            <>
